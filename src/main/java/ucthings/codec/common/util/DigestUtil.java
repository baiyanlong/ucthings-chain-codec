...
public class DigestUtil extends DigestUtils {
	...
	public static String sha1Hex(String data) {
		return DigestUtil.sha1Hex(data.getBytes(StandardCharsets.UTF_8));
	}
	...
	public static String sha256Hex(String data) {
		return DigestUtil.sha256Hex(data.getBytes(StandardCharsets.UTF_8));
	}
	...
	public static String sha384Hex(String data) {
		return DigestUtil.sha384Hex(data.getBytes(StandardCharsets.UTF_8));
	}
	...
	public static String sha512Hex(String data) {
		return DigestUtil.sha512Hex(data.getBytes(StandardCharsets.UTF_8));
	}
	...
	public static String hmacMd5Hex(String data, String key) {
		return DigestUtil.hmacMd5Hex(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha1Hex(String data, String key) {
		return DigestUtil.hmacSha1Hex(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha224Hex(String data, String key) {
		return DigestUtil.hmacSha224Hex(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha256Hex(String data, String key) {
		return DigestUtil.hmacSha256Hex(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha384Hex(String data, String key) {
		return DigestUtil.hmacSha384Hex(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static String hmacSha512Hex(String data, String key) {
		return DigestUtil.hmacSha512Hex(data.getBytes(StandardCharsets.UTF_8), key);
	}
	...
	public static boolean slowEquals(@Nullable String a, @Nullable String b) {
		...
		return DigestUtil.slowEquals(a.getBytes(StandardCharsets.UTF_8), b.getBytes(StandardCharsets.UTF_8));
	}
