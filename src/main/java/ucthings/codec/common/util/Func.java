...
import ucthings.codec.common.CharPool;
import ucthings.codec.common.StringPool;
...
public class Func {
	...
	public static <T> boolean contains(T[] array, final T element) {
		return ObjectUtil.contains(array, element);
	}
	...
	public static boolean contains(Iterator<?> iterator, Object element) {
		return ObjectUtil.contains(iterator, element);
	}
	...
	public static boolean contains(Enumeration<?> enumeration, Object element) {
		return ObjectUtil.contains(enumeration, element);
	}
	...
	public static <E> Set<E> ofImmutableSet(E... es) {
		return ObjectUtil.ofImmutableSet(es);
	}
	...
	public static <E> List<E> ofImmutableList(E... es) {
		return ObjectUtil.ofImmutableList(es);
	}
	...
	public static <T> T convert(Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
	 ...
	 * @param targetBean 需要赋值的对象
	 */
	public static void copyNonNull(Object source, Object targetBean) {
	...
	public static <T> T copyWithConvert(Object source, Class<T> clazz) {
	 ...
	 * @return List
	 */
	public static <T> List<T> copyWithConvert(Collection<?> sourceList, Class<T> targetClazz) {
